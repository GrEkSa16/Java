...
public class Crawler {
    ...
    /**
     * Программа должна принимать строку представляющий URL-адрес, с которого следует начать просмотр
     * и максимальную глубину поиска.
     * Сохраняет URL-адрес в виде строки с глубиной как URLDepthPair. Отслеживает
     * обработанные ссылки, ожидающие ссылки, просмотренные ссылки и глубину.
     * Распечатывает список всех обработанных ссылок с указанием их глубины.
     * Перебирает ожидающие URL-адреса в getAllLinks и добавляет их к обработанным и видимым URL-адресам.*/
