...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException, NoSuchAlgorithmException {
        ...
        while(choice != 0) {
            ...
            switch (choice) {
                case (1) -> {
                    System.out.println("Выберите метод 1-Encrypt, 2-Decrypt");
                    a = in.nextInt();
                    if (a==1)
                    {
                ...
                case (2) -> {
                    ...
                    System.out.println("Пешка - Pawn ");
                    System.out.println("Cлон - Bishop ");
                    System.out.println("Конь - Knight ");
                    System.out.println("Ладья - Rook ");
                    System.out.println("Королева - Queen ");
