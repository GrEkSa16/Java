...
public class AStarState
{
    ...
    private final HashMap<Location, Waypoint> openWp = new HashMap<>();

    //Инициализируем хэшкарту закрытых вершин и их местоположений
    private final HashMap<Location, Waypoint> closeWp = new HashMap<> ();
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        Set<Location> openWaypointKeys = openWp.keySet();
        ...
        while (i.hasNext())//возвращает true, если есть еще значения в списке
        {
            ...
            Waypoint waypoint = openWp.get(location);
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        if (openWp.containsKey(location))
        {
            ...
            Waypoint currentWaypoint = openWp.get(location);
